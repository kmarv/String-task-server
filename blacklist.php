...
$result=mysqli_query($dbcon,"select clientid,function,job from blacklist");
		...
		<section id="body" class="width">
			...
			<nav id="mainnav">
  				<ul>
                           		 ...
                           		 <li><a href="http://localhost/GROUP5/examples.php">Waiting Jobs</a></li>
                           		 <li><a href="#">Failure Rate</a></li>
                            		<li><a href="#">Success Rate</a></li>
                            		<li><a href="http://localhost/GROUP5/readyjobs.php">Ready jobs</a></li>
                            		<li class="selected-item"><a href="http://localhost/GROUP5/blacklist.php">Black Listed</a></li>
                        	</ul>
			</nav>
